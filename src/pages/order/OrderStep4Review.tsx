...
import type { Measurements, DesignSelections, ContactInfo } from '../../types/order';
...
export const OrderStep4Review: React.FC = () => {
  ...
  const handleSubmit = async () => {
    ...
    setTimeout(() => {
      ...
      const orderNumber = `TS-${new Date().getFullYear()}-${String(Math.floor(Math.random() * 100000)).padStart(5, '0')}`;
          ...
          <div className="space-y-6">
            ...
            <div className="card">
              ...
              <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                <div>
                  ...
                  <p className="font-semibold text-darzi-dark">{measurements.qad} cm</p>
                </div>
                <div>
                  <p className="text-sm text-gray-600">Shoulder (شانه)</p>
                  <p className="font-semibold text-darzi-dark">{measurements.shana} cm</p>
                </div>
                <div>
                  <p className="text-sm text-gray-600">Sleeve (آستین)</p>
                  <p className="font-semibold text-darzi-dark">{measurements.asteen} cm</p>
                </div>
                <div>
                  <p className="text-sm text-gray-600">Neck (یخن)</p>
                  <p className="font-semibold text-darzi-dark">{measurements.yakhan} cm</p>
                </div>
                <div>
                  <p className="text-sm text-gray-600">Chest (چهاتی)</p>
                  <p className="font-semibold text-darzi-dark">{measurements.chaati} cm</p>
                </div>
                <div>
                  <p className="text-sm text-gray-600">Underarm (بغل)</p>
                  <p className="font-semibold text-darzi-dark">{measurements.baghal} cm</p>
                </div>
                <div>
                  <p className="text-sm text-gray-600">Bottom Width (دامن)</p>
                  <p className="font-semibold text-darzi-dark">{measurements.daman} cm</p>
                </div>
                <div>
                  <p className="text-sm text-gray-600">Pant Length (قد شلوار)</p>
                  <p className="font-semibold text-darzi-dark">{measurements.qadShalwar} cm</p>
                </div>
                <div>
                  <p className="text-sm text-gray-600">Pant Opening (پاچه)</p>
                  <p className="font-semibold text-darzi-dark">{measurements.pacha} cm</p>
                </div>
                <div>
                  <p className="text-sm text-gray-600">Quantity (تعداد)</p>
                  <p className="font-semibold text-darzi-dark">{measurements.quantity}</p>
                </div>
              </div>
            </div>
            ...
            <div className="card">
              ...
              <div className="space-y-4">
                {/* Shirt Designs */}
                <div>
                  <h3 className="font-semibold text-darzi-dark mb-2">Shirt/Kameez</h3>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-3 text-sm">
                    <div className="flex items-center space-x-2">
                      <span className="text-gray-600">Sleeve Style:</span>
                      <span className="font-medium text-darzi-dark">{designs.sleeveStyle}</span>
                    </div>
                    <div className="flex items-center space-x-2">
                      <span className="text-gray-600">Collar Type:</span>
                      <span className="font-medium text-darzi-dark capitalize">{designs.collarType}</span>
                    </div>
                    <div className="flex items-center space-x-2">
                      <span className="text-gray-600">Front Pocket:</span>
                      <span className="font-medium text-darzi-dark">{designs.hasFrontPocket ? 'Yes' : 'No'}</span>
                    </div>
                    <div className="flex items-center space-x-2">
                      <span className="text-gray-600">Side Pockets:</span>
                      <span className="font-medium text-darzi-dark">{designs.hasSidePockets ? 'Yes' : 'No'}</span>
                    </div>
                    <div className="flex items-center space-x-2">
                      <span className="text-gray-600">Skirt Style:</span>
                      <span className="font-medium text-darzi-dark capitalize">{designs.skirtStyle}</span>
                    </div>
                  </div>
                </div>
                ...
                <div className="pt-3 border-t border-darzi-taupe">
                  <h3 className="font-semibold text-darzi-dark mb-2">Pants/Shalwar</h3>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-3 text-sm">
                    <div className="flex items-center space-x-2">
                      <span className="text-gray-600">Pants Style:</span>
                      <span className="font-medium text-darzi-dark capitalize">{designs.pantsStyle}</span>
                    </div>
                    <div className="flex items-center space-x-2">
                      <span className="text-gray-600">Pants Pocket:</span>
                      <span className="font-medium text-darzi-dark">{designs.hasPantsPocket ? 'Yes' : 'No'}</span>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="card">
              ...
              <div className="space-y-4">
                {/* Contact Info */}
                <div>
                  <h3 className="font-semibold text-darzi-dark mb-2">Contact</h3>
                  <div className="space-y-1 text-sm">
                    <p><span className="text-gray-600">Name:</span> <span className="font-medium text-darzi-dark">{contact.fullName}</span></p>
                    <p><span className="text-gray-600">Phone:</span> <span className="font-medium text-darzi-dark">{contact.phone}</span></p>
                    {contact.email && (
                      <p><span className="text-gray-600">Email:</span> <span className="font-medium text-darzi-dark">{contact.email}</span></p>
                    )}
                  </div>
                </div>
                ...
                {/* Shipping Address */}
                <div className="pt-3 border-t border-darzi-taupe">
                  <h3 className="font-semibold text-darzi-dark mb-2">Shipping Address</h3>
                ...
                {(contact.deliveryNotes || contact.fabricNotes) && (
                  <div className="pt-3 border-t border-darzi-taupe">
                    <h3 className="font-semibold text-darzi-dark mb-2">Special Instructions</h3>
                    {contact.deliveryNotes && (
                      <div className="mb-2">
                        <p className="text-xs text-gray-600 mb-1">Delivery Notes:</p>
                        <p className="text-sm text-darzi-dark">{contact.deliveryNotes}</p>
                      </div>
                    )}
                    {contact.fabricNotes && (
                      <div>
                        <p className="text-xs text-gray-600 mb-1">Fabric/Design Notes:</p>
                        <p className="text-sm text-darzi-dark">{contact.fabricNotes}</p>
                      </div>
                    )}
                  </div>
                )}
            ...
            <div className="card bg-darzi-beige border-2 border-darzi-gold">
              ...
              <ul className="space-y-1 text-sm text-gray-700">
                ...
                <li>• You will receive an order tracking number after submission</li>
